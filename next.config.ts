...
export default withJazz(
  {
    ...
    outputFileTracingExcludes: {
      "/api/chat": [
        "./node_modules/.pnpm/jazz-napi@2.0.0-alpha.54/node_modules/jazz-napi/jazz-napi.darwin-*.node",
        "./node_modules/.pnpm/jazz-napi@2.0.0-alpha.54/node_modules/jazz-napi/jazz-napi.win32-*.node",
